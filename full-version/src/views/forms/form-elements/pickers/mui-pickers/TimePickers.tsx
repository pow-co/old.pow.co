...
const TimePickers = () => {
  ...
  const [minMaxPicker, setMinMaxPicker] = useState<Date | null>(new Date(`${new Date().getFullYear()}-01-01 12:00`))
  const [oddTimePicker, setOddTimePicker] = useState<Date | null>(new Date(`${new Date().getFullYear()}-01-01 12:00`))
